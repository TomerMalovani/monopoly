...
Monopoly.rollDice = function () {
    ...
    if (result1 === result2) {
        console.log("double!! you got another turn");
...
Monopoly.HappyToBeHome = function (player) {
...
Monopoly.handlePassedGo = function () {
    var player = Monopoly.getCurrentPlayer();
    Monopoly.updatePlayersMoney(player, Monopoly.getPlayersMoney(player) - 100);
};
